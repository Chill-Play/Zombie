...
public class HQLevelUI : MonoBehaviour
{
    ...
    {
        giftsSpawnPoint.GetChild(index).GetChild(0).GetComponent<Image>().sprite = levelProgressionController.CurrentLevelProgression.Chests[index].chestInfo.OpenedIcon;
