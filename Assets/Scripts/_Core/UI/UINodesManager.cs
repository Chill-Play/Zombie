...
namespace GameFramework
{
    ...
    public class UINodesManager : MonoBehaviour
    {
        ...
        public List<UINode> GetNodesWithTag(SubjectTag tag)
        {
        ...
        public void ApplyTheme(UITheme theme)
        {
            ...
            {
                if (themeSettings[i].changingValue is SubjectTag)
                {
                    SubjectTag changingValue = themeSettings[i].changingValue as SubjectTag;
